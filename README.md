...
Данный форк полностью совместим с Claude Code
...
```bash
git clone https://github.com/crubly/FreeDeepseekAPI.git
cd FreeDeepseekAPI
npm run auth
npm start
```
...
<p align="center">
  На базе: <strong>ForgetMeAI</strong> · <a href="https://t.me/forgetmeai">Telegram</a>
</p>
